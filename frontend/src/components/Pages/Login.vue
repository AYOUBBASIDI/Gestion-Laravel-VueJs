	...
	<ParentTransition appear :visibility="true">
		<FormKit
			...
			:config="{
				classes: {
					input:
						'focus:ring-0 outline-0 p-2 focus:border-primary dark:focus:border-gray-200 bg-inherit block w-full sm:text-sm border-0 border-b-2 border-gray-300 dark:border-gray-700 dark:text-gray-200',
			...
			<div class="space-y-6">
				<div>
					...
					<div class="mt-1">
						<div>
							<div class="mt-1">
								<FormKit type="text" name="username" validation="required" />
							</div>
						</div>
					</div>
				...
				<BaseButton
					class="w-full flex justify-center border-none"
					design="primary"
					type="submit"
				>
					<FormKit
